...
const AnimeCard = ({ item }: { item: Anime }) => (
  ...
  >
    ...
    <div className="relative z-10 h-80 flex flex-col p-6">
      ...
      <div className="mt-auto transform translate-y-4 top-1 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
      ...
      <div className="flex gap-3 opacity-0 group-hover:opacity-100 absolute bottom-6 left-6 right-6 transition-all duration-500">
        <Link
          ...
          className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white text-center py-2.5 px-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25"
        >
          Ko'rish
        </Link>
