          ...
          <div className="flex flex-col p-4">
            <div className="flex flex-col py-4">
              ...
              <div className="flex gap-2">
                  {/* Leaderboard buttons */}
                  <button className="mb-2 cursor-pointer d-block font-bold fw-bold py-3 px-4 rounded-full bg-(--btn-3) hover:bg-(--btn-3-hover) transition-all duration-300 ease-out"
                  >
