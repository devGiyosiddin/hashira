        ...
        <header className="bg-white shadow-md py-4 px-6 flex items-center justify-between sticky top-0 z-50">
            <Link to="/" className="text-2xl font-bold text-blue-600">
                <span className='flex items-center gap-3'>
                    ...
                    <span className="text-lime-600">Hashira</span>
                </span>
            </Link>
            <nav className="space-x-4 text-sm sm:text-base">
                ...
                <Link to="/news" className="text-gray-700 hover:text-blue-500">Yangiliklar</Link>
                <Link to="/forum" className="text-gray-700 hover:text-blue-500">Forum</Link>
                <Link to="/shop" className="text-gray-700 hover:text-blue-500">Market</Link>
            </nav>
